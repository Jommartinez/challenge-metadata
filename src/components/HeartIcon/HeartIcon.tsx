...
export const HeartIcon = ({ isSelected, className }: HeartIconProps) => {
  return (
    <>
      {isSelected ? (
        <svg
          ...
          className={`${styles['heart-icon']} ${styles.selected} ${className}`}
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className={`${styles['heart-icon']} ${styles.unselected} ${className}`}
        >
